    ...
    private TestResult envelopedTest()
    {
        try
        {
            ...
            if (recip.getInfo() instanceof KeyTransRecipientInfo)
            {
                ...
                System.out.println(inf.getRecipientIdentifier());
                System.out.println(inf.getKeyEncryptionAlgorithm());
                System.out.println(inf.getVersion());
                System.out.println(inf.getEncryptedKey().parser());
                ...
                System.out.println("DER-Set = "+s.toASN1Object());
            }
            else
            {
