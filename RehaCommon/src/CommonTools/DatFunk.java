...
/*************************************************************************************/	
	...
	public static int TagDerWoche(String sdatum) {
		...
		Calendar cal1 = new GregorianCalendar();
		cal1.set( Integer.parseInt(datsplit[2]), Integer.parseInt(datsplit[1])-1, Integer.parseInt(datsplit[0]),0,0,0 ); 
	...
	public static long TageDifferenz(String saltdatum,String sneudatum){
		...
		return Math.round( mul3 / (24. * 60.*60.*1000.) );
	...
	public static long DatumsWert(String sdatum){
		...
		if(sdatum.contains(".")){
			String[] datsplit = sdatum.split("\\.");
			gcal.set( Integer.parseInt(datsplit[2]), 
					Integer.parseInt( (datsplit[1].startsWith("0") ? datsplit[1].substring(1,2) : datsplit[1]) )-1,
					Integer.parseInt(datsplit[0].startsWith("0") ? datsplit[0].substring(1,2) : datsplit[0]),0,0,0);
		}else{
			String[] datsplit = sdatum.split("-");
			gcal.set( Integer.parseInt(datsplit[0]),
					Integer.parseInt( (datsplit[1].startsWith("0") ? datsplit[1].substring(1,2) : datsplit[1]) ) -1 ,
					Integer.parseInt(datsplit[2].startsWith("0") ? datsplit[2].substring(1,2) : datsplit[2]),0,0,0);
		}
