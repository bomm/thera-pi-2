...
/*******************************************/
	public static int holeId(String tabelle, String feld){
		...
		try{
			ArztBausteine.thisClass.jFrame.setCursor(new Cursor(Cursor.WAIT_CURSOR));
			String sstmt1 = "insert into "+tabelle+" set "+feld+" = '"+ArztBausteine.thisClass.dieseMaschine+"'";
			stmt.execute(sstmt1);			
			String sstmt2 = "select id from "+tabelle+" where "+feld+" = '"+ArztBausteine.thisClass.dieseMaschine+"'";
