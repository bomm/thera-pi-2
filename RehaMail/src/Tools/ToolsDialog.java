...
public class ToolsDialog extends JXDialog implements FocusListener, ActionListener, MouseListener, WindowListener, KeyListener,RehaTPEventListener{
	...
	public ToolsDialog(JFrame thisFrame,String titel,JList list){
		super(thisFrame, (JComponent)RehaMail.thisFrame.getGlassPane());
			...
			public void mouseClicked(MouseEvent arg0) {
				if(arg0.getClickCount()== 2){
					if( ((JComponent)arg0.getSource()) instanceof JList){
						RehaMail.toolsDlgRueckgabe = Integer.valueOf(jList.getSelectedIndex());
	...
	public void keyPressed(KeyEvent arg0) {
		...
		if(arg0.getKeyCode()==27){
			RehaMail.toolsDlgRueckgabe = Integer.valueOf(-1);
			FensterSchliessen("dieses");			
		}
