...
public class JUmsaetzeInternal extends JRehaInternal implements RehaEventListener{
	/**
	 * 
	 */
	private static final long serialVersionUID = -6280289428685054774L;
	RehaEventClass rEvent = null;
	public JUmsaetzeInternal(String titel, ImageIcon img, int desktop) {
