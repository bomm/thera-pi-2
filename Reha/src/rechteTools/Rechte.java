...
public class Rechte {
	...
	public static int Sonstiges_unbelegt1				= 96;
	public static int Sonstiges_unbelegt2				= 97;
	public static int Sonstiges_unbelegt3				= 98;
	public static int Sonstiges_unbelegt4				= 99;
	public static int Sonstiges_unbelegt5				= 100;
	public static int Sonstiges_unbelegt6				= 101;
	public static int Sonstiges_unbelegt7				= 102;
	public static int Sonstiges_unbelegt8				= 103;
	public static int Sonstiges_unbelegt9				= 104;
	public static int Sonstiges_unbelegt10				= 105;
	...
	private static String[] rechteExt = {"Benutzerverwaltung öffnen","Benutzerrechte ändern","Super-User",
		...
		"Verkaufsmodul benutzen","Rehaformulare verwenden","unbelegt-1","unbelegt-2","unbelegt-3","unbelegt-4","unbelegt-5",
		"unbelegt-6","unbelegt-7","unbelegt-8","unbelegt-9","unbelegt-10"
