...
public class BenutzerRechte extends JXPanel{
	...
	String[] gruppe12 = {"Verkaufsmodul benutzen","Rehaformulare verwenden","Textbausteine für Gutachten anlegen/ändern","Rezepte in Historie schieben und umgekehrt",
			"im Rezept gespeicherte Behandlungsarten löschen","Geburtstagsbriefe erstellen","Sql-Modul verwenden","Reha-Fallsteuerung nach §301","Darf Thera-Pi-Nachrichten löschen",
			"Artikel in Verkaufsmodul-Modul anlegen","unbelegt 8 für zukünftige Erweiterungen","unbelegt 9 für zukünftige Erweiterungen",
