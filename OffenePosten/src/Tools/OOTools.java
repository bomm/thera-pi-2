...
public class OOTools{
	...
	public ITextDocument starteWriterMitDatei(String url){
		try {
			...
			IDocumentService documentService = OffenePosten.officeapplication.getDocumentService();
	...
	public static void ooOrgAnmelden(){
		new SwingWorker<Void,Void>(){
			...
			protected Void doInBackground() throws java.lang.Exception {
				...
				OffenePosten.thisFrame.setCursor(OffenePosten.thisClass.wartenCursor);
				try {
					if(!OffenePosten.officeapplication.isActive()){
						OffenePosten.starteOfficeApplication();
					}
	...
	public static void holeClipBoard() {
		try {
			...
			xMultiComponentFactory = (XMultiComponentFactory) OffenePosten.officeapplication.getDocumentService();
