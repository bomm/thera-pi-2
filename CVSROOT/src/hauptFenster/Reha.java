...
public class Reha implements FocusListener,ComponentListener,ContainerListener,MouseListener,MouseMotionListener,KeyListener,RehaEventListener, WindowListener, WindowStateListener  {
	...
	//public static String proghome = java.lang.System.getProperty("user.dir").substring(0,java.lang.System.getProperty("user.dir").lastIndexOf("Reha"));
	public static String proghome = ""; //java.lang.System.getProperty("user.dir")+"/";
	//public static String proghome = java.lang.System.getProperty("user.dir");
			...
			if (sDB=="SQL"){
	        	...
	        	try {
	    			if (sDB=="SQL"){
	    				...
	    				obj.conn = (Connection) DriverManager.getConnection(SystemConfig.vDatenBank.get(0).get(1),
...
final class DbNachladen implements Runnable{
	public void run(){
		...
		try {
			if (sDB=="SQL"){
				//obj.conn = (Connection) DriverManager.getConnection("jdbc:mysql://194.168.1.8:3306/dbf","entwickler","entwickler");
				Reha.thisClass.conn = (Connection) DriverManager.getConnection(SystemConfig.vDatenBank.get(0).get(1),"entwickler","entwickler");
...
final class PreisListenLaden implements Runnable{
	private void Einlesen(){
		...
		new SocketClient().setzeInitStand("INITENDE");
/*		System.out.println(ParameterLaden.vKGPreise);
		System.out.println(ParameterLaden.vMAPreise);
		System.out.println(ParameterLaden.vERPreise);
		System.out.println(ParameterLaden.vLOPreise);
		System.out.println(ParameterLaden.vRHPreise);
*/
